Allo !!!
Mise a jour global de tes modules pour la perf et la surive de ton build
Plus l'ajout de postcss
### Quand Faire un npm install ?
- dans un msg de commmit  : update deps, ou ADD module
- ou le package.json a changé
- ou t'as un module manquant

=> npm prune (nettoyage) + npm install

Le mode je veux etre très propre
=> rm -rf node_modules
pour tout effacer le dossier node_modules
